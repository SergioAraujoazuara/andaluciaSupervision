                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {editPpi.actividades.map((actividad, actividadIndex) => (
                        <div key={`actividad-${actividadIndex}`}>
                            ...
                            <button type="button" onClick={() => addSubactividad(actividadIndex)} className="mt-2 mb-2 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Añadir Subactividad
                            </button>
                        </div>
                    ))}
                    ...
                    <div className='mt-5'>
                        ...
                        <button type="submit" className='bg-sky-600 hover:bg-sky-700 text-white font-medium px-4 py-2 rounded-lg my-4 ms-5'>Guardar cambios</button>
                    </div>
                </form>
            </div>
