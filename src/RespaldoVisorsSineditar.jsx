...
export default function ViewerInspeccion() {
    ...
    const generatePDF = async () => {
        ...
        result = addText(`${documentoFormulario.nombre_responsable}`, 130, currentY, 11, regularFont, currentPage);
        currentPage = result.page;
        currentY = result.lastY;


        result = addText("Resultado: ", 50, currentY - 25, 11, boldFont, currentPage);
        currentPage = result.page;
        currentY = result.lastY;

        // Agregar el texto con el color determinado
        result = addText(documentoFormulario.resultadoInspeccion, 120, currentY, 14, boldFont, currentPage, color);
        ...
        result = addText("Firma: ", 50, currentY - 40, 11, boldFont, currentPage);
        currentPage = result.page;
        currentY = result.lastY;
    ...
    return (
        ...
        <div className="container mx-auto min-h-screen text-gray-500 xl:px-14 py-2">
            ...
            <div className='flex xl:flex-row flex-col-reverse p-4'>
                ...
                <div className="xl:w-1/2 w-full xl:pr-5">
                    {selectedLote ? (
                        ...
                        <div>
                            ...
                            <div className='px-5 py-4 text-white rounded-b-lg shadow-xl'>
                                <p> {selectedGlobalId ?
                                    <p className='font-medium bg-white text-gray-500'>Global id: <strong className='text-gray-500 font-normal text-sm  rounded-lg'>{selectedGlobalId}</strong></p> :
                                    <p className='text-gray-500 font-bold'>Global id: <strong className='text-gray-500 text-sm font-normal rounded-lg'>Sin seleccionar</strong></p>
                                }</p>

                                <p className='mt-3'> {selectedNameBim ?
                                    <p className='font-medium text-gray-500'>Nombre: <strong className='text-gray-500 font-normal text-sm rounded-lg'>{selectedNameBim}</strong></p> :
                                    <p className='text-gray-500 font-bold'>Nombre: <span className='text-gray-500 font-normal text-sm  rounded-lg'>Sin seleccionar</span></p>
                                }</p>
                            </div>
